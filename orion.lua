...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(3, 39, 143),
			Second = Color3.fromRGB(111, 37, 143),
			Stroke = Color3.fromRGB(11, 143, 2),
			Divider = Color3.fromRGB(143, 135, 22),
			Text = Color3.fromRGB(120, 49, 143),
			TextDark = Color3.fromRGB(120, 49, 143
		)
		}
	},
